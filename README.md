...
### 1. [Rotorhazard CSI Toolkit](https://github.com/FiorixF1/csi_export)
Description: a collection of plugins for RotorHazard aimed at race management of CSI Drone Racing events. It includes creation of classes and heats, custom overlays, class ranking, data export and a fancy management panel for the race director, all in a single solution.

### 2. [Rotorhazard Class Rank Brackets](https://github.com/FiorixF1/RotorHazard-Class-Rank-Brackets)
...
### 3. [HDZero VTX Coppa Italia firmware](https://github.com/FiorixF1/hdzero-vtx)
...
### 4. [HDZero Programmer](https://github.com/FiorixF1/hdzero-programmer)
